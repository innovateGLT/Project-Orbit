...
// app.js
angular.module('app', ['auth0','home', 'profile', 'project', 'user', 'alert', 'loaduser', 'help', 'angular-storage', 'angular-jwt', 'ngAnimate', 'angular-preload-image', 'ui.bootstrap', 'duScroll', 'ImgCache']);
